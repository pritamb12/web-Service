...
<jsp:useBean id="sampleAddProxyid" scope="session" class="org.demo.javabrains.AddProxy" />
<%
...
case 10:
        gotMethod = true;
        org.demo.javabrains.Add getAdd10mtemp = sampleAddProxyid.getAdd();
...
case 13:
        ...
        java.lang.String func13mtemp = sampleAddProxyid.func(a_1idTemp,b_2idTemp);
if(func13mtemp == null){
%>
<%=func13mtemp %>
<%
